  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
      <div className="w-full max-w-3xl bg-white rounded-lg shadow p-8">
        <h1 className="text-2xl font-semibold mb-4">resume-ai-enhancer</h1>
        <p className="text-sm text-gray-600 mb-6">Rewrite resumes to match job descriptions without inventing facts.</p>
            ...
            <EnhanceButton
              onClick={async () => {
                ...
                try {
                  ...
                  setResults({ error: 'Failed to call API' });
                }
              }}
            />
          </div>
